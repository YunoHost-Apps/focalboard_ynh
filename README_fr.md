...
**Version incluse :** 7.2.1~ynh1 *(:warning: Il s'agit de la branche `set-new-path`. La [branche `master`](https://github.com/YunoHost-Apps/focalboard_ynh/tree/master) utilisée dans le catalogue est actuellement en 7.1.0\~ynh1.)*
